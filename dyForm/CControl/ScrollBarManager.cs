        ...
        private ScrollBarHistTest ScrollBarHitTest(IntPtr hWnd)
        {
            ...
            if (this.Direction == Orientation.Horizontal)
            {
                if (NativeMethods.PtInRect(ref rECT, pt))
                {
                    ...
                    {
                        result = ScrollBarHistTest.LeftArrow;
                        return result;
                    }
                    ...
                    if (NativeMethods.PtInRect(ref rECT2, pt))
                    {
                        result = ScrollBarHistTest.RightArrow;
                        return result;
                    }
                    if (this._owner.RightToLeft == RightToLeft.Yes)
                    {
                    ...
                    if (NativeMethods.PtInRect(ref rECT2, pt))
                    {
                        result = ScrollBarHistTest.Thumb;
                        return result;
                    }
                    result = ScrollBarHistTest.Track;
                    return result;
                }
            }
            else
            {
                if (NativeMethods.PtInRect(ref rECT, pt))
                {
                    ...
                    if (NativeMethods.PtInRect(ref rECT2, pt))
                    {
                        result = ScrollBarHistTest.TopArrow;
                        return result;
                    }
                    ...
                    if (NativeMethods.PtInRect(ref rECT2, pt))
                    {
                        result = ScrollBarHistTest.BottomArrow;
                        return result;
                    }
