...
namespace dyForm.CControl
{
    public class SkinTextBox : UserControl
    {
        ...
        protected virtual void PositionTextBox()
        {
            if (this._icon != null)
            {
                base.Padding = new Padding(base.Padding.Left, base.Padding.Top + 23, 0, base.Padding.Bottom);
                this.flag = true;
            }
            else
            {
                if (this._icon == null)
                {
                    base.Padding = new Padding(base.Padding.Left, base.Padding.Top - 23, base.Padding.Right, base.Padding.Bottom);
                    this.flag = false;
                }
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Bitmap bitmap = (this.MouseBack == null) ? this.MouseBack : this.MouseBack;
            Bitmap bitmap2 = (this.NormlBack == null) ? this.MouseBack : this.NormlBack;
