...
namespace dyForm.CControl
{
    public class FrmCapture : Form
    {
        ...
        public FrmCapture()
        {
            ...
            {
                formClosingEventHandler = delegate(object s, FormClosingEventArgs e)
                {
            ...
            this.imgpb.MouseLeave += eventHandler;
        ...
        private void tBtn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                Filter = "位图(*.bmp)|*.bmp|JPEG(*.jpg)|*.jpg",
                FilterIndex = 1,
                FileName = "CAPTURE_" + this.GetTimeString()
            };
