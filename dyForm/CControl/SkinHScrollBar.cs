namespace dyForm.CControl
{
    ...
    public class SkinHScrollBar : HScrollBar, IScrollBarPaint
    {
        ...
        Label_00CA:
            ...
            {
                dyForm.CControl.ControlPaintEx.DrawScrollBarArraw(graphics, arrowRectangle, begin, backNormal, border, innerBorder, fore, e.Orientation, arrowDirection, changeColor);
            }
        }
        ...
        protected virtual void OnPaintScrollBarThumb(PaintScrollBarThumbEventArgs e)
        {
            if (e.Enabled)
            {
                ...
                using (new SmoothingModeGraphics(graphics))
                {
                    dyForm.CControl.ControlPaintEx.DrawScrollBarThumb(graphics, thumbRectangle, begin, backNormal, border, innerBorder, e.Orientation, changeColor);
                }
            }
        }
        ...
        protected virtual void OnPaintScrollBarTrack(PaintScrollBarTrackEventArgs e)
        {
            ...
            dyForm.CControl.ControlPaintEx.DrawScrollBarTrack(g, trackRectangle, gray, Color.White, e.Orientation);
        }
