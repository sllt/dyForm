namespace dyForm.CControl
{
    ...
    {
        int CreateStream(string pwcsName, uint grfMode, uint reserved1, uint reserved2, out dyForm.CControl.IStream ppstm);
        int OpenStream(string pwcsName, IntPtr reserved1, uint grfMode, uint reserved2, out dyForm.CControl.IStream ppstm);
