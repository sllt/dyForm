namespace dyForm.CControl
{
    ...
    public class SkinButtom : Button
    {
        ...
        private dyForm.SkinClass.RoundStyle _roundStyle;
        ...
        private dyForm.SkinClass.ControlState states;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if ((mouseBack != null) && (this.DrawType == DrawStyle.Img))
            {
                ...
                {
                    UpdateForm.CreateControlRegion(this, mouseBack, 1);
                }
                if (this.Palace)
                {
                    dyForm.CForm.ImageDrawRect.DrawRect(g, mouseBack, new Rectangle(clientRectangle.X, clientRectangle.Y, clientRectangle.Width, clientRectangle.Height), Rectangle.FromLTRB(this.BackRectangle.X, this.BackRectangle.Y, this.BackRectangle.Width, this.BackRectangle.Height), 1, 1);
                }
                else
                {
            ...
            if (base.Image != null)
            {
                if (string.IsNullOrEmpty(this.Text))
                {
                    ...
                    if ((empty.Width * empty.Height) != 0)
                    {
                        ...
                        withinThis = dyForm.CForm.ImageDrawRect.HAlignWithin(empty, withinThis, base.ImageAlign);
                        withinThis = dyForm.CForm.ImageDrawRect.VAlignWithin(empty, withinThis, base.ImageAlign);
                        if (!base.Enabled)
                        {
        ...
        public void RenderBackgroundInternal(Graphics g, Rectangle rect, Color baseColor, Color borderColor, Color innerBorderColor, dyForm.SkinClass.RoundStyle style, int roundWidth, float basePosition, bool drawBorder, bool drawGlass, LinearGradientMode mode)
        {
            if (drawBorder)
            {
                rect.Width--;
            ...
            using (LinearGradientBrush brush = new LinearGradientBrush(rect, Color.Transparent, Color.Transparent, mode))
            {
                ...
                if (style != dyForm.SkinClass.RoundStyle.None)
                {
                    ...
                    if (baseColor.A > 80)
                    {
                        ...
                        using (GraphicsPath path2 = GraphicsPathHelper.CreatePath(rectangle, roundWidth, dyForm.SkinClass.RoundStyle.Top, false))
                        {
        ...
        [Description("九宫绘画区域"), Category("Skin"), DefaultValue(typeof(Rectangle), "10,10,10,10")]
        ...
        [Description("按钮的绘画模式"), DefaultValue(typeof(DrawStyle), "2"), Category("Skin")]
        ...
        [Description("圆角大小"), Category("Skin"), DefaultValue(typeof(int), "8")]
        public int Radius
        {
            get
            {
        ...
        [Category("Skin"), Description("设置或获取按钮圆角的样式"), DefaultValue(typeof(dyForm.SkinClass.RoundStyle), "0")]
        public dyForm.SkinClass.RoundStyle RoundStyle
        {
            get
            {
