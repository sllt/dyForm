    ...
    public sealed class ColorConverterEx
    {
        ...
        public static void HslToRgb(HSL hsl, RGB rgb)
        {
            ...
            else
            {
                ...
                double num3 = (2.0 * hsl.Luminance) - num2;
                rgb.R = (byte) (255.0 * HueToRGB(num3, num2, vH + 0.33333333333333331));
                rgb.G = (byte) (255.0 * HueToRGB(num3, num2, vH));
                rgb.B = (byte) (255.0 * HueToRGB(num3, num2, vH - 0.33333333333333331));
            }
        }
        ...
        public static void RgbToHsl(RGB rgb, HSL hsl)
        {
            ...
            else
            {
                ...
                double num8 = (((num5 - num) / 6.0) + (num6 / 2.0)) / num6;
                double num9 = (((num5 - num2) / 6.0) + (num6 / 2.0)) / num6;
                double num10 = (((num5 - num3) / 6.0) + (num6 / 2.0)) / num6;
                if (num == num5)
                {
                    num7 = num10 - num9;
                }
