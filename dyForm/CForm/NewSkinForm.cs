...
namespace dyForm.CForm
{
    public class NewSkinForm : Form
    {
        ...
        public event NewSkinForm.SysBottomEventHandler SysBottomClick;
        [Category("Skin"), Description("Back属性值更改时引发的事件")]
        public event NewSkinForm.BackEventHandler BackChanged;
        public event EventHandler RendererChangled
        {
            add
            {
                base.Events.AddHandler(NewSkinForm.EventRendererChanged, value);
            }
            remove
            {
                base.Events.RemoveHandler(NewSkinForm.EventRendererChanged, value);
            }
        }
        ...
        protected Rectangle RealClientRect
        {
            get
            {
                ...
                {
                    result = new Rectangle(this._deltaRect.X, this._deltaRect.Y, base.Width - this._deltaRect.Width, base.Height - this._deltaRect.Height);
                }
                else
                {
        ...
        protected virtual void OnRendererChanged(EventArgs e)
        {
            ...
            EventHandler eventHandler = base.Events[NewSkinForm.EventRendererChanged] as EventHandler;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (this.Back != null && this.BackToColor)
            {
                ...
                else
                {
                    ...
                    graphics.FillRectangle(linearGradientBrush3, -(float)(this.Back.Width - base.Width), 0f, linearGradientBrush3.Rectangle.Width, linearGradientBrush3.Rectangle.Height);
                    graphics.FillRectangle(linearGradientBrush4, -(float)(this.Back.Width - base.Width), (float)(this.Back.Height - 50), linearGradientBrush4.Rectangle.Width, linearGradientBrush4.Rectangle.Height);
                }
            }
            base.OnPaint(e);
