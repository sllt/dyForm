namespace dyForm.CForm
{
    ...
    public class SkinFormColorTable
    {
        ...
        public static readonly Color _controlBoxActive = Color.FromArgb(0x33, 0x99, 0xcc);
        public static readonly Color _controlBoxDeactive = Color.FromArgb(0x58, 0xac, 0xda);
