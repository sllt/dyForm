namespace dyForm.CForm
{
    ...
    public class SkinMain : Form
    {
        ...
        {
            Bitmap original = new Bitmap(this.SkinBack);
            if (this.SkinTrankColor != Color.Transparent)
            {
                original.MakeTransparent(this.SkinTrankColor);
            }
            return new Bitmap(original, base.Size);
        }
        ...
        [DefaultValue(typeof(bool), "true"), Category("Skin"), Description("窗体是否可以移动")]
