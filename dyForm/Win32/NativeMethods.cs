namespace dyForm.Win32
{
    using dyForm.CControl;
    using dyForm.Win32.Callback;
    ...
    public class NativeMethods
    {
        ...
        [DllImport("kernel32.dll")]
        public static extern int RtlMoveMemory(ref dyForm.Win32.Struct.POINT destination, ref RECT Source, int length);
        [DllImport("user32.dll")]
        ...
        [DllImport("USER32.dll", CharSet=CharSet.Auto)]
        public static extern IntPtr SetWindowsHookEx(int idHook, dyForm.Win32.Callback.HookProc lpfn, int hMod, int dwThreadId);
        ...
        public struct ComboBoxInfo
        {
            ...
            public dyForm.Win32.NativeMethods.ComboBoxButtonState stateButton;
        ...
        public struct PCURSORINFO
        {
            ...
            public dyForm.Win32.NativeMethods.Point ptScreenPos;
        }
